    ...
    return (
        <div className={"flex flex-col gap-3 pt-6 w-1/3"}>
            ...
            <div className={"pt-5"}>
                ...
                <span className={'pl-2 text-gray-500'}>{props.description}</span>
            </div>
            <div className={"pt-5"}>
                ...
                <div className="card w-auto bg-base-100">
                    <div className="card-body">
                        ...
                        <p className={"text-gray-500 font-medium pl-2"}>{props.how_to_contribute}</p>
                        <span className={"text-neutral-700 font-bold"}>PRÉ-REQUISITOS:</span>
                        <p className={"text-gray-500 font-medium pl-2"}>{props.prerequisite}</p>
                    </div>
                </div>
            </div>
            <div className={"pt-5"}>
                ...
                <div className="card card-side items-top gap-5">
                    ...
                    <div className="center">
                        ...
                        <p className={"text-gray-500 font-medium pl-2"}>{props.descriptionOng}</p>
                    </div>
                </div>
            </div>
        </div>
